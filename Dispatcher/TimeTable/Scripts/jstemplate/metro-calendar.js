...
(function( $ ) 
    $.widget("metro.calendar", 
        ...
        options: 
            format: "yyyy-mm-dd"
            multiSelect: false
            startMode: 'day', //year, month, da
            weekStart: (METRO_WEEK_START != undefined ? METRO_WEEK_START : 0), // 0 - Sunday, 1 - Monda
            otherDays: false
            date: new Date()
            buttons: true
        ...
        _renderMonth: function()
            ...
            // Add empty days for previos mont
